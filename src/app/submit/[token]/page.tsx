          ...
          <div style={{ textAlign: 'center', padding: '40px 24px' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, color: '#78350f', lineHeight: 1.65, margin: 0 }}>
                Please inform your <strong>Class Teacher</strong> or <strong>ID Card Coordinator</strong> for your class. All change requests will be processed together <strong>after the submission deadline</strong>, once data from the entire school has been collected.
              </p>
            </div>
          </div>
          <BracketDexFormFooter />
